...
import { PRIORITIES, STATUSES, TASK_TYPES } from '../../utils/helpers'

export default function TaskForm({ onSubmit, onClose, projectId, members = [], sprints = [] }) {
  const [form, setForm] = useState({
    title: '', description: '', type: 'Task',
    status: 'Todo', priority: 'Medium',
    dueDate: '', assignedTo: '', sprintId: '', projectId,
  })
    ...
    <Modal title="New Task" onClose={onClose}>
      <form onSubmit={handleSubmit} className="space-y-4">
        ...
        <div>
          ...
          <textarea className="input-field resize-none" rows={2} placeholder="Task description"
        ...
        <div className="grid grid-cols-2 gap-3">
          ...
          <div>
            ...
            <select className="input-field" value={form.sprintId} onChange={(e) => set('sprintId', e.target.value)}>
